        ...
        <div className="text-center mb-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-4">
            ...
            <Button
              variant="secondary"
              size="sm"
              onClick={() => navigate('/progresschart')}
              className="rounded-full"
            >
              View Progress
            </Button>
            <Button
              variant="secondary"
              size="sm"
              onClick={() => navigate('/creditpackages')}
              className="rounded-full"
            >
          ...
          <h1 className="text-4xl font-serif font-bold text-primary mb-4">Your Student Advisor</h1>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Ask me anything! I'm here to help you with your queries.
          </p>
